...
export default function SimulationPage() {
  ...
  return (
    <>
      ...
      <Head>
        <title>Future Simulation | MeVerse - Your Digital Twin</title>
        <meta name="description" content="Simulate your potential futures with MeVerse" />
        ...
        >
          ...
          <MotionBox
            ...
            bgGradient={colorMode === 'dark' 
              ? 'radial-gradient(circle at top right, cyan.600, transparent 60%), radial-gradient(circle at bottom left, cyan.400, transparent 60%)' 
              : 'radial-gradient(circle at top right, cyan.300, transparent 60%), radial-gradient(circle at bottom left, cyan.200, transparent 60%)'
            }
          />
          ...
          <MotionBox
            ...
            height="300px"
            borderRadius="full"
            bg={colorMode === 'dark' ? 'rgba(76, 201, 240, 0.05)' : 'rgba(76, 201, 240, 0.05)'}
            filter="blur(60px)"
            top="10%"
            right="-150px"
            zIndex="0"
          ...
          <MotionBox
            ...
            height="250px"
            borderRadius="full"
            bg={colorMode === 'dark' ? 'rgba(76, 201, 240, 0.03)' : 'rgba(76, 201, 240, 0.03)'}
            filter="blur(50px)"
            bottom="10%"
            left="-100px"
            zIndex="0"
          ...
          <Container maxW="container.xl" position="relative" zIndex="1" py={{ base: 4, md: 8 }}>
            ...
            >
              <Flex align="center" mb={2}>
                <Icon as={FaClock} mr={3} color="cyan.400" fontSize="2xl" />
                <MotionHeading
                  as="h2"
                  fontSize="3xl"
                  bgGradient={colorMode === 'dark' 
              ...
              <Text color={colorMode === 'dark' ? 'gray.400' : 'gray.600'} ml={10}>
                Explore different "what if" scenarios based on your behavior patterns
              </Text>
            </MotionBox>
